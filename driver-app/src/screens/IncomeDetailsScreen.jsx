  ...
  return (
    <SafeAreaView className="flex-1 bg-[#F8FAFC]">
      <View className="px-5 py-4 flex-row items-center border-b border-gray-100 bg-white shadow-sm">
        ...
        <Text className="text-xl font-bold text-[#0F172A] ml-2 tracking-tight">Income Details</Text>
      </View>
      <View className="flex-1 justify-center items-center px-6">
        <Text className="text-gray-400 text-base text-center">Detailed income breakdown will be available here soon.</Text>
      </View>
    </SafeAreaView>
  );
}
